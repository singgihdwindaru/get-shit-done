...
<execution_context>
@~/.copilot/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @~/.copilot/get-shit-done/workflows/session-report.md end-to-end.
</process>
