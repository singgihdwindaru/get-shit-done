...
<!-- For checkpoint task examples and patterns, see @~/.copilot/get-shit-done/references/checkpoints.md -->
...
See `~/.copilot/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `~/.copilot/get-shit-done/workflows/verify-phase.md` for verification logic.
