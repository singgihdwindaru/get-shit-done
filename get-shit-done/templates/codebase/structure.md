...
**commands/gsd/**
- Purpose: Skill definitions for GitHub Copilot
...
- `copilot-instructions.md` - Instructions for GitHub Copilot when working in this repo
...
- Usage: Reference from command with `@~/.copilot/get-shit-done/workflows/{name}.md`
